...
cls
echo Running Part One of the test. Please stay in a quiet enironment.
pause
echo false > noise.tmp
C:\Python27\ArcGIS10.3\python.exe memory_reaction_test.py noNoise
cls
echo ---------------------------------------------------------------
echo Now please listen to white_noise.mp3 for at least 60 seconds with headphones, KEEP NOISE PLAYING, and then we will repeat the test.
